...
for page in xrange(n):
   ...
   #     plot.Set(box, TextSize=0.02, BorderSize=0, FillColor=0, TextAlign=12, Margin=0.5)
...
#    pads = plot.TwoPadSplitColumns(0.7, 0.1, 0.3)
    pads[0].SetGrid(1, 0)
    pads[0].SetTickx(1)
    pads[1].SetGrid(1, 0)
    pads[1].SetTickx(1)
   ...
   #     newbox.SetX1(ROOT.gStyle.GetPadLeftMargin()+0.001)
        newbox.SetX1(ROOT.gStyle.GetPadLeftMargin()+0.1)
#FIXME
#        newbox.SetX2(0.7-0.001)
        newbox.SetX2(0.7-0.1)
