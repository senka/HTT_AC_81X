...
//    VString chns = {"tt"};
    ...
    cats["em"] = {
        {1, "em_0jet"},
        {2, "em_boosted"},
        {3, "em_vbf_D0_DCP_minus"},
        {4, "em_vbf_D0_DCP_plus"}
    ...
    cats["et"] = {
        {1, "et_0jet"},
        {2, "et_boosted"},
        {3, "et_vbf_D0_DCP_minus"},
        {4, "et_vbf_D0_DCP_plus"}
    ...
    cats["mt"] = {
        {1, "mt_0jet"},
        {2, "mt_boosted"},
        {3, "mt_vbf_D0_DCP_minus"},
        {4, "mt_vbf_D0_DCP_plus"}
    ...
    */
    ...
    cats["tt"] = {        
        {1, "tt_0jet"},
        {2, "tt_boosted"},
        {3, "tt_vbf_D0_DCP_minus"},
        {4, "tt_vbf_D0_DCP_plus"}
    };
...
//    
    ...
    ch::AddSMRun2Systematics_D0merged_D0added_DCP_ggHSyst_rw(cb, control_region, mm_fit, ttbar_fit);
