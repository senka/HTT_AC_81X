...
//    bkg_procs["em"] = {"ZTT", "W", "QCD", "ZL", "TT", "VV", "EWKZ", "HWW_gg125", "HWW_qq125"};
    ...
    cats["et"] = {
        {1, "et_0jet"},
        {2, "et_boosted"},
        {3, "et_vbf_DL1_0p0to0p2"},
        {4, "et_vbf_DL1_0p2to0p4"},
        {5, "et_vbf_DL1_0p4to0p8"},
        {6, "et_vbf_DL1_0p8to1p0"}
    ...
    cats["mt"] = {
        {1, "mt_0jet"},
        {2, "mt_boosted"},
        {3, "mt_vbf_DL1_0p0to0p2"},
        {4, "mt_vbf_DL1_0p2to0p4"},
        {5, "mt_vbf_DL1_0p4to0p8"},
        {6, "mt_vbf_DL1_0p8to1p0"}
    ...
    cats["em"] = {
        {1, "em_0jet"},
        {2, "em_boosted"},
        {3, "em_vbf_DL1_0p0to0p2"},
        {4, "em_vbf_DL1_0p2to0p4"},
        {5, "em_vbf_DL1_0p4to0p8"},
        {6, "em_vbf_DL1_0p8to1p0"}
    ...
    cats["tt"] = {        
        ...
        {2, "tt_boosted"},
        {3, "tt_vbf_DL1_0to0p2"},
        {4, "tt_vbf_DL1_0p2to0p4"},
        {5, "tt_vbf_DL1_0p4to0p8"},
        {6, "tt_vbf_DL1_0p8to1"}
    };
...
//                queue.push_back(make_pair(binid+5,chn+"_antiiso_vbf_cr"));
            ...
            if (ch::contains({"tt"}, chn)) {
                ...
                queue.push_back(make_pair(binid+2,chn+"_vbf_DL1_0to0p2_qcd_cr"));
                queue.push_back(make_pair(binid+3,chn+"_vbf_DL1_0p2to0p4_qcd_cr"));
                queue.push_back(make_pair(binid+4,chn+"_vbf_DL1_0p4to0p8_qcd_cr"));
                queue.push_back(make_pair(binid+5,chn+"_vbf_DL1_0p8to1_qcd_cr"));
