...
//    bkg_procs["em"] = {"ZTT", "W", "QCD", "ZL", "TT", "VV", "EWKZ", "HWW_gg125", "HWW_qq125"};
    ...
    cats["em"] = {
        {1, "em_0jet"},
        {2, "em_boosted"},
        {3, "em_vbf_D0hplus_0p0to0p2"},
        {4, "em_vbf_D0hplus_0p2to0p4"},
        {5, "em_vbf_D0hplus_0p4to0p8"},
        {6, "em_vbf_D0hplus_0p8to1p0"}
...
//                queue.push_back(make_pair(binid+5,chn+"_antiiso_vbf_cr"));
    ...
    vector<string> sig_procs = {"GGH2Jets_sm_M","reweighted_WH_htt_0PM","reweighted_ZH_htt_0PM","reweighted_qqH_htt_0PM","reweighted_qqH_htt_0PH","reweighted_ZH_htt_0PH","reweighted_WH_htt_0PH","reweighted_qqH_htt_0PHf05ph0","reweighted_ZH_htt_0PHf05ph0","reweighted_WH_htt_0PHf05ph0"};
...
//    
    ...
    ch::AddSMRun2Systematics_D0merged_DCP_ggHSyst_fa2_rw(cb, control_region, mm_fit, ttbar_fit);
