...
//                queue.push_back(make_pair(binid+5,chn+"_antiiso_vbf_cr"));
    ...
    vector<string> sig_procs = {"GGH2Jets_sm_M","WH_htt_0PM","ZH_htt_0PM","qqH_htt_0PM","qqH_htt_0PH","ZH_htt_0PH","WH_htt_0PH","qqH_htt_0PHf05ph0","ZH_htt_0PHf05ph0","WH_htt_0PHf05ph0"};
    // just to trick the code to create ttbar dir, since no 0PH signal in input root files!
...
//    
    ...
    ch::AddSMRun2Systematics_D0merged_DCP_ggHSyst_fa2(cb, control_region, mm_fit, ttbar_fit);
