...
//    VString chns = {"tt"};
    ...
    cats["em"] = {
        {1, "em_0jet"},
        {2, "em_boosted"},
        {3, "em_vbf_D0_0p0to0p2_DCP_minus"},
        {4, "em_vbf_D0_0p2to0p4_DCP_minus"},
        {5, "em_vbf_D0_0p4to0p8_DCP_minus"},
        {6, "em_vbf_D0_0p8to1p0_DCP_minus"},
        {7, "em_vbf_D0_0p0to0p2_DCP_plus"},
        {8, "em_vbf_D0_0p2to0p4_DCP_plus"},
        {9, "em_vbf_D0_0p4to0p8_DCP_plus"},
        {10, "em_vbf_D0_0p8to1p0_DCP_plus"}
...
//    
    ...
    ch::AddSMRun2Systematics_D0merged_DCP_ggHSyst_rw(cb, control_region, mm_fit, ttbar_fit);
