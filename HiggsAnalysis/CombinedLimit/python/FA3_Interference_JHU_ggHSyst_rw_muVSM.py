...
class FA3_Interference_JHU_ggHSyst_rw_muVSM(PhysicsModel):
...
#        self.modelBuilder.out.var("muf").setAttribute("flatParam")
        ...
        self.modelBuilder.factory_('expr::smCoupling_VBF("@0*{sigma1_VBF}/(@1**2*{sigma1_VBF} + @2**2*{sigma3_VBF} + @1*@2*({sigmaa1a3int_VBF} - 2.*{sigma1_VBF})*sqrt({sigma3_VBF}/{sigma1_VBF}) )*@1**2 - @0*{sigma1_VBF}/(@1**2*{sigma1_VBF} + @2**2*{sigma3_VBF} + @1*@2*({sigmaa1a3int_VBF} - 2.*{sigma1_VBF})*sqrt({sigma3_VBF}/{sigma1_VBF}) )*@1*@2*sqrt({sigma3_VBF}/{sigma1_VBF})", muV,a1,a3)'.format(**xsecs))
        self.modelBuilder.factory_('expr::smCoupling_ZH("@0*{sigma1_ZH}/(@1**2*{sigma1_ZH} + @2**2*{sigma3_ZH} + @1*@2*({sigmaa1a3int_ZH} - 2.*{sigma1_ZH})*sqrt({sigma3_ZH}/{sigma1_ZH}) )*@1**2 - @0*{sigma1_ZH}/(@1**2*{sigma1_ZH} + @2**2*{sigma3_ZH} + @1*@2*({sigmaa1a3int_ZH} - 2.*{sigma1_ZH})*sqrt({sigma3_ZH}/{sigma1_ZH}) )*@1*@2*sqrt({sigma3_ZH}/{sigma1_ZH})", muV,a1,a3)'.format(**xsecs))
        self.modelBuilder.factory_('expr::smCoupling_WH("@0*{sigma1_WH}/(@1**2*{sigma1_WH} + @2**2*{sigma3_WH} + @1*@2*({sigmaa1a3int_WH} - 2.*{sigma1_WH})*sqrt({sigma3_WH}/{sigma1_WH}) )*@1**2 - @0*{sigma1_WH}/(@1**2*{sigma1_WH} + @2**2*{sigma3_WH} + @1*@2*({sigmaa1a3int_WH} - 2.*{sigma1_WH})*sqrt({sigma3_WH}/{sigma1_WH}) )*@1*@2*sqrt({sigma3_WH}/{sigma1_WH})", muV,a1,a3)'.format(**xsecs))
...
#        self.modelBuilder.factory_('expr::bsmCoupling_WH("@0*@1**2*{sigma3_WH}/{sigma1_WH} - @0*@1*@2*sqrt({sigma3_WH}/{sigma1_WH})", muV,a3,a1)'.format(**xsecs))
        ...
        self.modelBuilder.factory_('expr::bsmCoupling_VBF("@0*{sigma1_VBF}/(@1**2*{sigma1_VBF} + @2**2*{sigma3_VBF} + @1*@2*({sigmaa1a3int_VBF} - 2.*{sigma1_VBF})*sqrt({sigma3_VBF}/{sigma1_VBF}) )*@1**2*{sigma3_VBF}/{sigma1_VBF} - @0*{sigma1_VBF}/(@1**2*{sigma1_VBF} + @2**2*{sigma3_VBF} + @1*@2*({sigmaa1a3int_VBF} - 2.*{sigma1_VBF})*sqrt({sigma3_VBF}/{sigma1_VBF}) )*@1*@2*sqrt({sigma3_VBF}/{sigma1_VBF})", muV,a3,a1)'.format(**xsecs))
        self.modelBuilder.factory_('expr::bsmCoupling_ZH("@0*{sigma1_ZH}/(@1**2*{sigma1_ZH} + @2**2*{sigma3_ZH} + @1*@2*({sigmaa1a3int_ZH} - 2.*{sigma1_ZH})*sqrt({sigma3_ZH}/{sigma1_ZH}) )*@1**2*{sigma3_ZH}/{sigma1_ZH} - @0*{sigma1_ZH}/(@1**2*{sigma1_ZH} + @2**2*{sigma3_ZH} + @1*@2*({sigmaa1a3int_ZH} - 2.*{sigma1_ZH})*sqrt({sigma3_ZH}/{sigma1_ZH}) )*@1*@2*sqrt({sigma3_ZH}/{sigma1_ZH})", muV,a3,a1)'.format(**xsecs))
        self.modelBuilder.factory_('expr::bsmCoupling_WH("@0*{sigma1_WH}/(@1**2*{sigma1_WH} + @2**2*{sigma3_WH} + @1*@2*({sigmaa1a3int_WH} - 2.*{sigma1_WH})*sqrt({sigma3_WH}/{sigma1_WH}) )*@1**2*{sigma3_WH}/{sigma1_WH} - @0*{sigma1_WH}/(@1**2*{sigma1_WH} + @2**2*{sigma3_WH} + @1*@2*({sigmaa1a3int_WH} - 2.*{sigma1_WH})*sqrt({sigma3_WH}/{sigma1_WH}) )*@1*@2*sqrt({sigma3_WH}/{sigma1_WH})", muV,a3,a1)'.format(**xsecs))
...
#        self.modelBuilder.factory_('expr::intCoupling_WH("@0*@1*@2*sqrt({sigma3_WH}/{sigma1_WH})*2", muV,a1,a3)'.format(**xsecs))
        ...
        self.modelBuilder.factory_('expr::intCoupling_VBF("@0*{sigma1_VBF}/(@1**2*{sigma1_VBF} + @2**2*{sigma3_VBF} + @1*@2*({sigmaa1a3int_VBF} - 2.*{sigma1_VBF})*sqrt({sigma3_VBF}/{sigma1_VBF}) )*@1*@2*sqrt({sigma3_VBF}/{sigma1_VBF})*{sigmaa1a3int_VBF}/{sigma1_VBF}", muV,a1,a3)'.format(**xsecs))
        self.modelBuilder.factory_('expr::intCoupling_ZH("@0*{sigma1_ZH}/(@1**2*{sigma1_ZH} + @2**2*{sigma3_ZH} + @1*@2*({sigmaa1a3int_ZH} - 2.*{sigma1_ZH})*sqrt({sigma3_ZH}/{sigma1_ZH}) )*@1*@2*sqrt({sigma3_ZH}/{sigma1_ZH})*{sigmaa1a3int_ZH}/{sigma1_ZH}", muV,a1,a3)'.format(**xsecs))
        self.modelBuilder.factory_('expr::intCoupling_WH("@0*{sigma1_WH}/(@1**2*{sigma1_WH} + @2**2*{sigma3_WH} + @1*@2*({sigmaa1a3int_WH} - 2.*{sigma1_WH})*sqrt({sigma3_WH}/{sigma1_WH}) )*@1*@2*sqrt({sigma3_WH}/{sigma1_WH})*{sigmaa1a3int_WH}/{sigma1_WH}", muV,a1,a3)'.format(**xsecs))
...
FA3_Interference_JHU_ggHSyst_rw_muVSM = FA3_Interference_JHU_ggHSyst_rw_muVSM()
